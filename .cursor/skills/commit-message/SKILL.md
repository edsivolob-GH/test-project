...
description: Generates conventional commit messages by analyzing staged git changes. Use when the user asks to commit, write a commit message, or mentions git commits.
...
Analyze the current staged changes and generates a conventional commit message.
