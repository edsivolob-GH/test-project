...
description: Performs a thorough code review covering complexity, security, and style. Use when the user asks for a review, asks to check this code, or mentions PR review.
...
Run `python ~/.cursor/skills/code-review/scripts/complexity_check.py <file>` and report any functions flagged as overly long.
